...
- 🌐 **Leadership:** Web Development Officer for the **Society of Asian Scientists and Engineers (SASE)**, automating organizational workflows and building platforms for 400+ members
...
- Designed and implemented a centralized **Event Catalog** system using **Java** and **Spring Boot** for **5,000+ developers**, making **1M+ Kafka events** discoverable across multiple engineering units and reducing event discovery time by **40%**.
- Optimized search performance by indexing developer-filtered trends tracked in Grafana, reducing query times by **60%**.
...
- Collaborated in an Agile team of **8** across SDLC workflows while monitoring **50+ event schemas**.
...
- Progressed from Web Development Intern to Web Development Officer, creating internal tools and automating organizational workflows for **400+ members**.
...
- Grew event attendance by **25%** across **50+ events** through custom bots, SEO, and LinkedIn outreach.
...
- Designed over 20 custom columns featuring dynamic field formatting (color-coding, sortable filters), reducing data lookup times by **85%** for researchers and accelerating data analysis.
...
A **Node.js-based music streaming platform** developed by a team of five for University of Houston musicians and listeners, supporting **30 concurrent campus users**. It allows UH students and alumni to upload, share, and stream original music. Users can upload songs with metadata, create playlists, and stream tracks through a clean, interactive UI. The backend uses **Azure MySQL** for structured data storage and **Azure Blob Storage** for media file handling, with a responsive frontend built in **React**.
